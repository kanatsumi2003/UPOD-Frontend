...
export default function VerifyCodeForm() {
  ...
  const VerifyCodeSchema = Yup.object().shape({
    code1: Yup.string().trim().required('Code is required'),
    code2: Yup.string().trim().required('Code is required'),
    code3: Yup.string().trim().required('Code is required'),
    code4: Yup.string().trim().required('Code is required'),
    code5: Yup.string().trim().required('Code is required'),
    code6: Yup.string().trim().required('Code is required'),
  });
